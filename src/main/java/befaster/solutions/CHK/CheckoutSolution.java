...
public class CheckoutSolution {
    ...
    private static final int UNIT_PRICE_K = 70;
    ...
    private static final int UNIT_PRICE_S = 20;
    ...
    private static final int UNIT_PRICE_X = 17;
    private static final int UNIT_PRICE_Y = 20;
    private static final int UNIT_PRICE_Z = 21;
